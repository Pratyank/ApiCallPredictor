...
class TestMLRanker:
    ...
    def mock_lgb_model(self):
        ...
        model.feature_importance = Mock(return_value=np.array([0.4, 0.3, 0.2, 0.1, 0.0, 0.0]))
        return model
    ...
    def test_model_not_trained_error(self):
        ...
        untrained_ranker.rank_candidates = Mock(side_effect=ValueError("Model not trained"))
    ...
    def test_single_candidate_ranking(self, ml_ranker):
        ...
        single_candidate = [{"endpoint": "/users", "method": "GET", "raw_confidence": 0.8}]
        expected_result = [{"endpoint": "/users", "method": "GET", "score": 0.8, "rank": 1}]
    ...
    def test_feature_importance(self, ml_ranker):
        ...
        ml_ranker.get_feature_importance = Mock(return_value=expected_importance)
...
class TestFeatureExtractor:
    ...
    def feature_extractor(self):
        ...
        extractor.feature_names = [
            ...
            "resource_match", "workflow_distance", "bigram_prob", "trigram_prob"
        ]
        return extractor
    ...
    def test_extract_sequence_features(self, feature_extractor):
        ...
        feature_extractor.extract_sequence_features = Mock(return_value=expected_features)
    ...
    def test_extract_candidate_features(self, feature_extractor):
        ...
        feature_extractor.extract_candidate_features = Mock(return_value=expected_features)
        
        features = feature_extractor.extract_candidate_features(candidate, recent_events)
    ...
    def test_extract_prompt_features(self, feature_extractor):
        ...
        candidate = {"endpoint": "/users/{id}", "method": "PUT", "description": "Update user by ID"}
        ...
        feature_extractor.extract_prompt_features = Mock(return_value=expected_features)
    ...
    def test_calculate_transition_probabilities(self, feature_extractor):
        ...
        feature_extractor.calculate_transition_probs = Mock(return_value=expected_probs)
        
        probs = feature_extractor.calculate_transition_probs(last_actions, candidate)
    ...
    def test_normalize_features(self, feature_extractor):
        ...
        raw_features = np.array([[100, 0.5, 1000], [200, 0.8, 2000], [50, 0.3, 500]])
...
class TestModelTrainer:
    ...
    def mock_training_data(self):
        ...
        return {
            ...
            "groups": np.repeat(range(100), 10)  # 100 groups of 10 candidates each
        }
    ...
    def test_generate_synthetic_data(self, model_trainer):
        ...
        model_trainer.generate_synthetic_data = Mock(return_value=expected_data)
        
        synthetic_data = model_trainer.generate_synthetic_data(n_sequences=1000)
